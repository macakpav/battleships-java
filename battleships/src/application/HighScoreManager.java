...
public class HighScoreManager {
	...
	private boolean saveHighScores() {
		...
		try {
			if (file.isDirectory()) {
				System.out.println(
						"Couldnt create high scores file. Directory in place.");
				return false;
			}

			if (!file.exists() && !file.createNewFile()) {
				System.out.println("Couldnt create high scores file");
				return false;
			}
		} catch (IOException e) {
			System.out.println("Couldnt create high scores file. IO Exception.");
			e.printStackTrace();
			return false;
		}
